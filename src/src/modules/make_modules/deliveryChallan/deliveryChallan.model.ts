...
import { deliveryChallanStatus, TDeliveryChallan } from './deliveryChallan.interface';
...
const deliveryChallanSchema = new Schema<TDeliveryChallan>(
  {
...
export const DeliveryChallanModel = model<TDeliveryChallan>('DeliveryChallan', deliveryChallanSchema);
