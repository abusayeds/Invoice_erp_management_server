...
import { enforcePlanLimit } from "../../make_modules/subscription/guard/subscription.guard";
...
router.post("/create-user-by-company", authMiddleware(role.company), enforcePlanLimit("users"), userController.createUserByCompany);
