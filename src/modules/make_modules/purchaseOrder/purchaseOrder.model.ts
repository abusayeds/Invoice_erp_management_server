...
import { purchaseOrderStatus, TPurchaseOrder } from './purchaseOrder.interface';
...
const purchaseOrderSchema = new Schema<TPurchaseOrder>(
  {
    ...
    status: { type: String, enum: purchaseOrderStatus, default: 'Draft' },
...
export const PurchaseOrderModel = model<TPurchaseOrder>('PurchaseOrder', purchaseOrderSchema);
