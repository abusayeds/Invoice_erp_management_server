...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
export const generatePaymentReceivedPDF = async (settings: any, res: any) => {
  ...
  if (header.header !== false) {
    ...
    if (company.website !== false) { drawText(data.company.website, infoX, leftY, { color: "#0066cc" }); leftY += 11; }
     ...
     drawText(`RECEIVED FROM`,  infoX, leftY , { color: "#1111" }) ; leftY += 11; 
...
module.exports = { generatePaymentReceivedPDF };