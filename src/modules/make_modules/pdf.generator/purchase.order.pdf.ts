...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
export const generatePurchaseOrderPDF = async (settings: any, res: any) => {
  ...
  if (header.header !== false) {
    ...
    if (header.total_outstanding !== false) detailRows.push(["Bill #", data.outstanding]);
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    drawText("Vendor To:", billX, billY, { bold: true }); billY += 12;
