...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
export const generateSalesReceiptPDF = async (settings: any, res: any) => {
  ...
  // ════════════════════════════════════════════════════════════════════════
  {
    ...
    drawText("Seles Receipt To:", billX, billY, { bold: true }); billY += 12;
...
module.exports = { generateSalesReceiptPDF };