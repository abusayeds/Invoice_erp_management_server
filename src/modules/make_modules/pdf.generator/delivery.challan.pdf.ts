  ...
  products: [
    {
      ...
      description:
        "Create FREE unlimited invoices for freelancers, small business owners, and contractors for 7 days.",
      hsn: "HSN0001",
      quantity: 1,
      unitPrice: 160,
      discount: 6,
  ...
  services: [
    {
      ...
      description:
        "Create added attachment feature on Invoice, Estimate, Purchase Order, and Credit Note.",
      sac: "SAC0001",
      quantity: 1,
      rate: 120,
      discount: "6%",
    ...
    },
    {
      ...
      description:
        "Complete redesign of dashboard and reporting module with new design system.",
      sac: "SAC0002",
      quantity: 2,
      rate: 200,
      discount: "10%",
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
export const generateDeliveryChallanPDF = async (settings: any, res: any) => {
  ...
  const drawTableRow = (
    ...
    cells.forEach((cell) => {
      ...
      doc
        ...
        .text(String(cell.value ?? ""), cx + 2, yy + 3, {
          width: cell.w - 4,
