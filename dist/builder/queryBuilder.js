...
class queryBuilder {
    ...
    filter() {
        ...
        const startDate = (_a = this.query) === null || _a === void 0 ? void 0 : _a.startDate;
        const endDate = (_b = this.query) === null || _b === void 0 ? void 0 : _b.endDate;
        if (startDate || endDate) {
            ...
            copyQuery.createdAt = dateFilter;
        }
        this.modelQuery = (_c = this === null || this === void 0 ? void 0 : this.modelQuery) === null || _c === void 0 ? void 0 : _c.find(copyQuery);
        return this;
    }
    sort() {
        var _a, _b, _c;
