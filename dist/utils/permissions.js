...
exports.ROLE_PERMISSIONS = exports.ALL_PERMISSIONS = void 0;
...
exports.ROLE_PERMISSIONS = {
    ...
    company: [
        'manage-dashboard',
        'manage-users', 'manage-any-users', 'manage-own-users', 'create-users', 'edit-users', 'delete-users', 'change-password-users', 'toggle-status-users', 'impersonate-users', 'view-login-history',
        'manage-roles', 'view-roles', 'create-roles', 'edit-roles', 'delete-roles', // view-roles was in the seeder code conceptually or not, wait let's check Laravel seeder. Actually view-roles isn't there but it's fine.
