...
exports.generatePaymentMoodPDF = void 0;
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generatePaymentMoodPDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (header.header !== false) {
        ...
        drawText(`PAYMENT TO : `, infoX, leftY, { color: "#1111" });
        leftY += 11;
...
exports.generatePaymentMoodPDF = generatePaymentMoodPDF;
module.exports = { generatePaymentMoodPDF: exports.generatePaymentMoodPDF };
