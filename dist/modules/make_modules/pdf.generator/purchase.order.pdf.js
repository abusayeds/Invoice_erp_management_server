...
// ─── Dummy Data ───────────────────────────────────────────────────────────────
const getDummyPurchaseOrderData = () => ({
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generatePurchaseOrderPDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = getDummyPurchaseOrderData();
    const s = settings || {};
    const style = s.style || {};
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("PURCHASE ORDER", margin.left, y, {
        ...
        if (header.total_outstanding !== false)
            detailRows.push(["Bill #", data.outstanding]);
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Vendor To:", billX, billY, { bold: true });
        billY += 12;
...
module.exports = { generatePurchaseOrderPDF: exports.generatePurchaseOrderPDF };
