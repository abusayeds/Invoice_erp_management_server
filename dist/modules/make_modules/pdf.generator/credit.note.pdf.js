...
exports.generateCreditNotePDF = void 0;
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generateCreditNotePDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = getDummyCreditNoteData();
    const s = settings || {};
    const style = s.style || {};
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("CREDIT NOTE", margin.left, y, {
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Credit To:", billX, billY, { bold: true });
        billY += 12;
...
module.exports = { generateCreditNotePDF: exports.generateCreditNotePDF };
