...
exports.generateSalesReceiptPDF = void 0;
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generateSalesReceiptPDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = getDummySalesReceiData();
    const s = settings || {};
    const style = s.style || {};
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("SELES RECEIPT", margin.left, y, {
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Seles Receipt To:", billX, billY, { bold: true });
        billY += 12;
...
exports.generateSalesReceiptPDF = generateSalesReceiptPDF;
module.exports = { generateSalesReceiptPDF: exports.generateSalesReceiptPDF };
