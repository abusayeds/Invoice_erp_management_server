...
exports.generateProformaInvoicePDF = void 0;
...
// ─── Dummy Data ───────────────────────────────────────────────────────────────
const getDummyProformaInvoiceData = () => ({
...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generateProformaInvoicePDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = getDummyProformaInvoiceData();
    const s = settings || {};
    const style = s.style || {};
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("PROFORMA INVOICE", margin.left, y, {
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Proforma invoice To:", billX, billY, { bold: true });
        billY += 12;
...
module.exports = { generateProformaInvoicePDF: exports.generateProformaInvoicePDF };
