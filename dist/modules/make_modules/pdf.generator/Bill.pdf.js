...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generateBillPDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("BILL", margin.left, y, {
        ...
        if (header.number !== false)
            detailRows.push(["Bill #", data.invoiceNumber]);
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Bill To:", billX, billY, { bold: true });
        billY += 12;
...
module.exports = { generateBillPDF: exports.generateBillPDF };
