...
// MAIN GENERATOR
// ════════════════════════════════════════════════════════════════════════════
const generateEstimatePDF = (settings, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = getDummyEstimateData();
    const s = settings || {};
    const style = s.style || {};
    ...
    if (header.header !== false) {
        setFont(true, 16);
        doc.fillColor(rgb(textColor)).text("ESTIMATE", margin.left, y, {
    ...
    // ════════════════════════════════════════════════════════════════════════
    {
        ...
        let billY = y;
        let shipY = y;
        drawText("Estimate To:", billX, billY, { bold: true });
        billY += 12;
...
module.exports = { generateEstimatePDF: exports.generateEstimatePDF };
